...
var fatTCO = function (n) {
	function auxFunction (acc, i) {
			while (true) {
				if (!i) {
					return acc;
				} else {
	...
	return auxFunction(1, n);
};
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Recursao$main = function () {
	var b = fatTCO(5);
	var a = fat(5);
...
_Platform_export({'Recursao':{'init':_VirtualDom_init($author$project$Recursao$main)(0)(0)}});}(this));